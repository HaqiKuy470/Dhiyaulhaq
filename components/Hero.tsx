...
export default function Hero() {
  return (
    // Background cerah dengan pattern kotak-kotak opsional, border hitam tebal
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 md:space-y-8 z-10">
          ...
          <p className="text-black font-bold text-sm md:text-lg max-w-lg leading-relaxed bg-pink-400 p-4 border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
            Mahasiswa PTI yang gemar mengeksplorasi Artificial Intelligence, Machine Learning, dan Financial Tech.
          </p>
          ...
          <div className="flex flex-wrap gap-4 items-center pt-2">
            ...
            >
              <Download className="w-6 h-6" /> Lihat CV
            </Link>

            {/* Social Icons dalam Box Kotak */}
        ...
        {/* --- KOTAK KODE (PIXEL / WINDOWS 95 VIBE) --- */}
        <div className="relative hidden md:block w-full">
          {/* Efek kotak bertumpuk brutalist */}
          ...
          <div className="w-full relative border-4 border-black bg-white flex flex-col">
            ...
            <div className="p-6 font-bold text-sm sm:text-base text-black bg-[#e5e5e5]">
              ...
              <p className="mt-2">{"}"};</p>
              <div className="w-4 h-6 bg-black mt-4 animate-ping" /> {/* Cursor berkedip retro */}
            </div>
          </div>
        </div>

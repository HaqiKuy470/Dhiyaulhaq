    ...
    <section className="py-24 bg-slate-950 border-t border-slate-900/50 relative">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <motion.div 
              whileHover={{ y: -5 }}
              className="bg-slate-900/40 border border-slate-800 rounded-xl overflow-hidden relative group h-52 flex items-center justify-center"
            >
            ...
            >
              ...
              <img 
                ...
                alt="Languages" 
                className="h-full w-auto object-contain p-2 scale-110" 
              />
            </motion.div>
            ...
            >
              ...
              <img 
                ...
                alt="Stats" 
                className="h-full w-auto object-contain p-2 scale-105"
              />
            </motion.div>
